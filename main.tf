...
resource "azurerm_log_analytics_solution" "main" {
  ...
  location              = coalesce(var.location, data.azurerm_resource_group.main.location)
  resource_group_name   = var.log_analytics_workspace != null && var.log_analytics_workspace.resource_group_name != null ? var.log_analytics_workspace.resource_group_name : var.resource_group_name
