...
| <a name="input_ultra_ssd_enabled"></a> [ultra\_ssd\_enabled](#ultra\_ssd\_enabled)                                                                                              | (Optional) Used to specify whether the UltraSSD is enabled in the Default Node Pool. Defaults to false.                                                                                                                                                                                                    | `bool`                                                              | `false`                      |    no    |
